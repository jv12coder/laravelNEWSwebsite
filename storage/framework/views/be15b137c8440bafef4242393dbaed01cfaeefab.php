...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/css/techcss.css')); ?>">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#about">
                <img src="<?php echo e(asset('frontend/images/logo_main.png')); ?>" class="logo img-responsive">
            </a>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-6.5" style="padding-right: 5%;">
                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                    <img src="<?php echo e(asset('frontend/images/card/apple.jpg')); ?>" class="card-img" height="150px" alt="..." style="border-radius: 20px 20px 0px 20px ;">
                    </div>
                    <div class="col-md-8">
                    <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 700px; background: transparent; border: none; ">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('frontend/images/card/google.jpg')); ?>" class="card-img" height="150px" alt="..." style="border-radius: 20px 20px 0px 20px ;">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 700px; background: transparent; border: none; ">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('frontend/images/card/nokia.jpg')); ?>" class="card-img" height="150px" alt="..." style="border-radius: 20px 20px 0px 20px ;">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 700px; background: transparent; border: none; ">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?php echo e(asset('frontend/images/card/pubg.jpg')); ?>" class="card-img" height="150px" alt="..." style="border-radius: 20px 20px 0px 20px ;">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="row" style="padding-left: 60px;">
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/nokia.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                    ...
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/google.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text">Last updated 3 mins ago</p>
                    ...
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/pubg.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text">Last updated 3 mins ago</p>
                    ...
                    <br><br><br><br>
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/Realme.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text">Last updated 3 mins ago</p>
                    ...
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/ransomware.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text">Last updated 3 mins ago</p>
                    ...
                    <div class="card bg-light font-weight-bold text-white" style="margin: 10px;">
                        <img src="<?php echo e(asset('frontend/images/card/telegram.jpg')); ?>" class="card-img" style="width: 400px;" alt="...">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text">Last updated 3 mins ago</p>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, <?php echo e(date('Y')); ?> <a href="#">News + .</a> <strong> Developed &amp; <i class="far fa-heart"></i> by </strong>
                        <a href="">satyam </a>
                    </p>
                </div>
            </div>
